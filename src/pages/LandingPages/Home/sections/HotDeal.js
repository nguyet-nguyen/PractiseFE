...
import {getAllProducts, getProductHotDeal} from "../../../../features/Api";
...
function HotDeal() {
    ...
    return (
        <section id="HotDealHome">
            <div
                className="md:flex md:justify-between md:items-center md:flex-wrap justify-start items-center w-full mb-2">
                <span className="md:text-3xl text-xl font-bold flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 stroke-amber-600 fill-amber-600"
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 gap-6 md:mt-6 mt-3">
                <CardProduct proList={hotDeal} homePage={true} hotDeal={true}/>
            </div>
            <div className="flex justify-center items-c md:hidden">
                <button type="button" className="inline-block px-6 py-2 mt-5 border-2 border-amber-700 text-amber-700 font-medium 
                    ...
                    transition duration-100 ease-in-out">See More
                </button>
            </div>
        </section>
    );
