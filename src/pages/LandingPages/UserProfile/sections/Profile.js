                ...
                <section className="relative py-16 bg-gray-300">
                    <>
                        {loading ?
                          ...
                          <span
                              className="text-xl font-bold block uppercase tracking-wide text-gray-700 hover:text-amber-600">
                            {itemsInCart.length}
                          </span>
                                                        </Link>
                        ...
                        <span className="text-xl font-bold block uppercase tracking-wide text-gray-700">
                          {usersOrd.length}
                                        ...
                                        >
                                            <div
                                                className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable relative w-auto pointer-events-none">
                                                <div
                              ...
                              shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                            ...
                                                            <button
                                                                className=" active:bg-amber-500 uppercase text-amber-500 border border-amber-500 font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                                onClick={() =>
                                                                    onFilterStatus(1)
                                                                }>
                                                                <i
                                                            ...
                                                            <button
                                                                className=" active:bg-blue-500 uppercase text-blue-500 border border-blue-500 font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                                onClick={() =>
                                                                    onFilterStatus(2)
                                                                }>
                                                                <i
                                                            ...
                                                            <button type="button"
                                                                    className=" active:bg-green-500  uppercase text-green-500 border border-green-500 font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                                    onClick={() =>
                                                                        onFilterStatus(4)
                                                                    }>
                                                                <i
                                                            ...
                                                            <button
                                                                className=" active:bg-red-500 uppercase text-red-500 border border-red-500 font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                                onClick={() =>
                                                                    onFilterStatus(3)
                                                                }>
                                                                <i
                                                                ...
                                                                >
                                                                    <div className="h-60 mb-2  lg:h-48">
                                                                        <div className="md:flex items-strech py-1">
                                                                            <div
                                                                                className="pl-1 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                                  ...
                                  {order.status}
                                                                        ...
                                                                        >
                                                                            <div
                                                                                className="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-200">
                                                                                <div
                                                                                    className="md:w-4/12 2xl:w-2/12 w-full">
                                                                                ...
                                                                                <div
                                                                                    className="md:pl-3 lg:ml-7 md:w-8/12 2xl:w-10/12 flex flex-col justify-center">
                                                                                    ...
                                                                                    <div
                                                                                        className="flex items-center justify-between w-full md:pt-0 mt-3">
                                                                    ...
                                                                    <div
                                                                        className="flex justify-between items-center border-t border-gray-200 py-4 px-1">
                                <span className="text-lg font-bold text-amber-600">
                                  {numberFormat(order.totalPrice)}
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            >
                                                                                <div
                                                                                    className="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable relative w-auto pointer-events-none">
                                                                                    <div
                                                                                        className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                                                                                        <div
                                                                                            className="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
