...
const ProductsTable = () => {
    ...
    const searchProduct = (e) => {
        ...
        productList.forEach((product) => {
            if (
                product.name.toString().toLowerCase().indexOf(searchKey) > -1 ||
            ...
            cell: (record) => {
                return (
                    <>
                        ...
                        <Link
                            to={`/admin/products/update-product/${record.id}`}
                        ...
                        <button
                            type="button"
                            className="px-6 py-2.5 bg-white text-red-700 font-medium text-xs
                                    ...
                                    <div className="md:flex w-full">
                                        ...
                                        >
                                            ...
                                            outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-600`}
                                                                ...
                                                                {errors.SizeM &&
                                                                    errors.SizeM.type === "required" && (
                                                                        <p className="text-red-500 text-xs mt-3 italic">
                                                                            Value required
                                                                        </p>
                                                                    )}
                                                                {errors.SizeL &&
                                                                    errors.SizeL.type === "required" && (
                                                                        <p className="text-red-500 text-xs mt-3 italic">
                                                                            Value required
                                                                        </p>
                                                                    )}
  ...
  duration-150 ease-in-out mr-4"
                            ...
                            <button
                                type="button"
                                className="inline-block px-6 py-2 border-2 border-red-600 text-red-600 font-medium text-xs
  leading-tight uppercase rounded hover:bg-red-700 hover:text-white focus:outline-none focus:ring-0 transition
  duration-150 ease-in-out"
                                data-bs-dismiss="modal"
                                onClick={() => onHandDel(idDelete)}
                            >
                                Delete
                            </button>
                        </div>
