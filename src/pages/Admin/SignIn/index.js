                  ...
                  <div className="rounded-t mb-0 px-6 py-6">
                    <div className="text-center my-3">
                      ...
                      {!showMess || messErr != "" ? (
                        ...
                        >
                          <div className="bg-red-600 flex justify-end items-center px-3 pt-2 border-red-500 rounded-t-lg">
                      ...
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          ...
                          className={`border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white 
                                                    ...
                                                    ${
                                                      errors.email &&
                                                      "border-red-600 ring-red-500 focus:ring-red-500 focus:border-red-600 border-1"
                                                    }
                                                    `}
                          placeholder="Email"
